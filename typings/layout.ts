...
export type LayoutOffset = number | SignalRef | {
...
export type RowColumnParam = number | SignalRef |
  {row?: number | SignalRef, column?: number | SignalRef};

export type Layout = SignalRef | {
  align?: LayoutAlign | {row?: LayoutAlign, column?: LayoutAlign},
  bounds?: LayoutBounds,
